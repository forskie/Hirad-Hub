    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Student'), ('teacher', 'Teacher'), ('director', 'Director'), ('admin', 'Admin')], default='student', max_length=20)),
                ('username', models.CharField(max_length=150, unique=True)),
                ('score', models.PositiveIntegerField(db_index=True, default=0)),
                ('level', models.PositiveIntegerField(default=1)),
                ('title', models.CharField(blank=True, default='Newcomer', max_length=50)),
